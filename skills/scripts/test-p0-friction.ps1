...
$zhCases = @(
    @{ Hint = '安卓 APK 加固 decompilation'; Expect = 'apk-reverse' },
    @{ Hint = 'penetration testing port scanning SQLinjection'; Expect = 'pentest-tools' },
    @{ Hint = '前端signature JSreverse engineering'; Expect = 'js-reverse' }
)
